#!/usr/bin/env bash
# cd $CYTOKIT_ANALYSIS_REPO_DIR/analysis/experiments/spheroid/20190719-co-culture; source env.sh && bash -e pipeline.sh

#EXPERIMENTS=`cat experiments.csv | tail -n +2 | grep '02.5mT-np-0uMsta-XY01'`
