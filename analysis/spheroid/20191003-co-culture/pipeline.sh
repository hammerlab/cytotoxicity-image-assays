#!/usr/bin/env bash
# cd /lab/repos/cytotoxicity-image-assays/analysis/spheroid/20191003-co-culture; source env.sh && bash -e pipeline.sh

#EXPERIMENTS=`cat experiments.csv | tail -n +2 | grep '0500kT-0uM-np-XY01-1'`
EXPERIMENTS=`cat experiments.csv | tail -n +2 | grep -v '0500kT-0uM-np-XY01-1'`
